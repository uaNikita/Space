...
/***/ function(module, exports, __webpack_require__) {
	...
	var arr = (0, _lodash.times)(100, function () {
	   return (0, _lodash.random)(0, 100);
	});
	...
	var sortBy1 = function sortBy1(arr) {
	   arr = (0, _lodash.clone)(arr);
	   ...
	   for (var i = 0; i < arrLength; i += 1) {
	      ...
	      for (var j = 0; j < arrLength - i - 1; j += 1) {
